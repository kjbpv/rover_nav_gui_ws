...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'astro_arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/halrover/git/kyle/rover_nav_gui_ws/src/astro_arm/${idir}'.  Ask the maintainer 'kyle <kyle@todo.todo>' to fix it.")
    endif()
